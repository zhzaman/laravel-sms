            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="{{ URL::to('index') }}"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Students<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{URL::to('addstudent/create')}}">Add student</a>
                                </li>
                                <li>
                                    <a href="{{URL::to('addstudent/')}}">Student List</a>
                                </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="{{URL::to('subject')}}">Subject List</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
